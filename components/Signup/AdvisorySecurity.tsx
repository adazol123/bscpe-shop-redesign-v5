      ...
      <div className="flex gap-2 ">
        ...
        <div>
          ...
          <p className="text-[0.8em] text-black/40 leading-3 mb-3">
            ...
            <b>(Firebase Auth)</b>. We don&apos;t have full control over with
            those credentials as those are managed by google authentication
            through firebase auth provider which secured by hash map and salting
            security.{" "}
